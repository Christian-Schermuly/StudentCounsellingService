...
public class elektrotechnikInfo  extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.elektrotechnik));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilElektrotechnik));
        passtText.setText(getString(R.string.passtElektrotechnik));
        nachdemstudiumText.setText(R.string.nachdemstudiumElektrotechnik);
        mehrinfosText.setText(R.string.mehrinfosElektrotechnik);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("kCPUG-ieqJc"); // your video to play
    }
