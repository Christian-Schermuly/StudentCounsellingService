...
public class produktentwicklungInfo  extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.produktentwicklung));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilProduktentwicklung));
        passtText.setText(getString(R.string.passtProduktentwicklung));
        nachdemstudiumText.setText(R.string.nachdemstudiumProduktentwicklung);
        mehrinfosText.setText(R.string.mehrinfosProduktentwicklung);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("gTEXNwrSyTc"); // your video to play
    }
