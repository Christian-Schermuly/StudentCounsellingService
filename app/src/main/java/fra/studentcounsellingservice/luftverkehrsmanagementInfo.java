...
public class luftverkehrsmanagementInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.luftverkehrsmanagement));
        abschlussText.setText(getString(R.string.bachelorOA));
        profilText.setText(getString(R.string.profilLufverkehrsmanagement));
        passtText.setText(getString(R.string.passtLufverkehrsmanagement));
        nachdemstudiumText.setText(R.string.nachdemstudiumLufverkehrsmanagement);
        mehrinfosText.setText(R.string.mehrinfosLufverkehrsmanagement);
