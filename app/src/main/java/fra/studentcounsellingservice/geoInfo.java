...
public class geoInfo extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.geoinformation));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilGeol));
        passtText.setText(getString(R.string.passtGeo));
        nachdemstudiumText.setText(R.string.nachdemstudiumGeo);
        mehrinfosText.setText(R.string.mehrinfosGeo);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("Zstfezn18d4"); // your video to play
    }
