...
public class serviceengineeringInfo  extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.wirtschaftsingenieur));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilServiceengineering));
        passtText.setText(getString(R.string.passtServiceengineering));
        nachdemstudiumText.setText(R.string.nachdemstudiumServiceengineering);
        mehrinfosText.setText(R.string.mehrinfosServiceengineering);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("tJU1244Jnkk"); // your video to play
    }
