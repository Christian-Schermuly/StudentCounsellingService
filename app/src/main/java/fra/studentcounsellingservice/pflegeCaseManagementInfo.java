...
public class pflegeCaseManagementInfo extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.pflegeCase));
        abschlussText.setText(getString(R.string.bachelorOS));
        profilText.setText(getString(R.string.profilPflegeCaseManagement));
        passtText.setText(getString(R.string.passtPflegeCaseManagement));
        nachdemstudiumText.setText(R.string.nachdemstudiumPflegeCaseManagement);
        mehrinfosText.setText(R.string.mehrinfosPflegeCaseManagement);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("2uO04Ql_QEg"); // your video to play
    }
