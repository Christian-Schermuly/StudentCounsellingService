...
public class bioInfo extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.bioverfahrenstechnik));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilBio));
        passtText.setText(getString(R.string.passtBio));
        nachdemstudiumText.setText(R.string.nachdemstudiumBio);
        mehrinfosText.setText(R.string.mehrinfosBio);
