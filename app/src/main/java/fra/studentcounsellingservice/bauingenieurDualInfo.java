...
public class bauingenieurDualInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.bauingenieurwesenDual));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilBauingenieurDual));
        passtText.setText(getString(R.string.passtBauingenieurDual));
        nachdemstudiumText.setText(R.string.nachdemstudiumBauningenieurDual);
        mehrinfosText.setText(R.string.mehrinfosBauingenieurDual);
