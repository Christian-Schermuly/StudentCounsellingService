...
public class publicAdminInfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.publicAdmin));
        abschlussText.setText(getString(R.string.bachelorOA));
        profilText.setText(getString(R.string.profilPublicAdmin));
        passtText.setText(getString(R.string.passtPublicAdmin));
        nachdemstudiumText.setText(R.string.nachdemstudiumPublicAdmin);
        mehrinfosText.setText(R.string.mehrinfosPublicAdmin);
