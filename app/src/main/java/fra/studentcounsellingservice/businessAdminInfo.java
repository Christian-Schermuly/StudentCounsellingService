...
public class businessAdminInfo extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.businessAdmin));
        abschlussText.setText(getString(R.string.bachelorOA));
        profilText.setText(getString(R.string.profilBusinessAdmin));
        passtText.setText(getString(R.string.passtBusinessAdmin));
        nachdemstudiumText.setText(R.string.nachdemstudiumBusinessAdmin);
        mehrinfosText.setText(R.string.mehrinfosBusinessAdmin);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("k_rkhcfXFjQ"); // your video to play
    }
