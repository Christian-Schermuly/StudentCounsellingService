...
public class informatikInfo  extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.informatik));
        abschlussText.setText(getString(R.string.bachelorOS));
        profilText.setText(getString(R.string.profilInformatik));
        passtText.setText(getString(R.string.passtInformatik));
        nachdemstudiumText.setText(R.string.nachdemstudiumInformatik);
        mehrinfosText.setText(R.string.mehrinfosInformatik);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("Ez4GgU5v2G4"); // your video to play
    }
