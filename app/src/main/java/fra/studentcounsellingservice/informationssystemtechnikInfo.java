...
public class informationssystemtechnikInfo  extends YouTubeBaseActivity  implements YouTubePlayer.OnInitializedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Set Text-Content
        studiengangText.setText(getString(R.string.informationstechnik));
        abschlussText.setText(getString(R.string.bachelorOE));
        profilText.setText(getString(R.string.profilInformationssystemtechnik));
        passtText.setText(getString(R.string.passtInformationssystemtechnik));
        nachdemstudiumText.setText(R.string.nachdemstudiumInformationssystemtechnik);
        mehrinfosText.setText(R.string.mehrinfosInformationssystemtechnik);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider,
        ...
        if (!wasRestored) player.cueVideo("dSjIJ3fIH50"); // your video to play
    }
