...
public class beratungActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent myIntent = new Intent(beratungActivity.this, MainActivity.class);
                beratungActivity.this.startActivity(myIntent);
            }
        });
    ...
    /*View.OnClickListener doSomething = new View.OnClickListener() {
        @Override
        public void onClick(View v) {

            Drawable imgMinus = getResources().getDrawable(R.drawable.minus);
            Drawable imgPlus = getResources().getDrawable(R.drawable.plus);
            imgPlus.setBounds(0,0,50,50);
            imgMinus.setBounds(0,0,50,50);
